...
beforeAll(async () => {
  ...
  globalThis.fetch = vi.fn(async (input: URL | RequestInfo) => {
    ...
    if (url.includes("example.com/feed.xml")) {
      return new Response(
        `<?xml version="1.0" encoding="UTF-8"?><rss><channel><item><title>Battery paper</title><description>battery systems</description><pubDate>${new Date().toUTCString()}</pubDate><link>https://paper.test/1</link></item></channel></rss>`,
        { status: 200 }
      );
    }
